                            ...
                            if (game->hud.getChoice()=="Yes")
                            {
                                ...
                                if (itemId!=-1)
								{
									...
									else if (itemId>=28 && itemId<=32)
									{
										...
										lookUp[28] = {{30,89}, {52,53}, {62,63}, {96,97}};
										lookUp[29] = {{30,31}, {104,105}, {110,111}, {76,77}};
										lookUp[30] = {{30,78}, {115,116}, {91,92}, {94,95}};
										lookUp[31] = {{30,36}, {101,102}, {113,114}, {65,66}, {73,74}};
										lookUp[32] = {{30,75}, {59,60}};
