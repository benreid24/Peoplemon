...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3353;
	#define RC_FILEVERSION 9,7,268,1464
	#define RC_FILEVERSION_STRING "9, 7, 268, 1464\0"
	static const char FULLVERSION_STRING [] = "9.7.268.1464";
