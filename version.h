...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3504;
	#define RC_FILEVERSION 10,1,16,91
	#define RC_FILEVERSION_STRING "10, 1, 16, 91\0"
	static const char FULLVERSION_STRING [] = "10.1.16.91";
