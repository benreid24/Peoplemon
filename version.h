...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3986;
	#define RC_FILEVERSION 11,5,167,881
	#define RC_FILEVERSION_STRING "11, 5, 167, 881\0"
	static const char FULLVERSION_STRING [] = "11.5.167.881";
