...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3745;
	#define RC_FILEVERSION 11,1,27,158
	#define RC_FILEVERSION_STRING "11, 1, 27, 158\0"
	static const char FULLVERSION_STRING [] = "11.1.27.158";
