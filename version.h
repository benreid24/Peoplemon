...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3421;
	#define RC_FILEVERSION 9,8,299,1620
	#define RC_FILEVERSION_STRING "9, 8, 299, 1620\0"
	static const char FULLVERSION_STRING [] = "9.8.299.1620";
