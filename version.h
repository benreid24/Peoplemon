...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 5394;
	#define RC_FILEVERSION 14,3,65,342
	#define RC_FILEVERSION_STRING "14, 3, 65, 342\0"
	static const char FULLVERSION_STRING [] = "14.3.65.342";
