...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3398;
	#define RC_FILEVERSION 9,8,288,1570
	#define RC_FILEVERSION_STRING "9, 8, 288, 1570\0"
	static const char FULLVERSION_STRING [] = "9.8.288.1570";
