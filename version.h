...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 2842;
	#define RC_FILEVERSION 9,1,52,297
	#define RC_FILEVERSION_STRING "9, 1, 52, 297\0"
	static const char FULLVERSION_STRING [] = "9.1.52.297";
