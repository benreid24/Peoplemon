...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 5306;
	#define RC_FILEVERSION 14,2,12,73
	#define RC_FILEVERSION_STRING "14, 2, 12, 73\0"
	static const char FULLVERSION_STRING [] = "14.2.12.73";
