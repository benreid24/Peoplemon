...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3520;
	#define RC_FILEVERSION 10,1,33,196
	#define RC_FILEVERSION_STRING "10, 1, 33, 196\0"
	static const char FULLVERSION_STRING [] = "10.1.33.196";
