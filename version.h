...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3584;
	#define RC_FILEVERSION 10,4,61,350
	#define RC_FILEVERSION_STRING "10, 4, 61, 350\0"
	static const char FULLVERSION_STRING [] = "10.4.61.350";
