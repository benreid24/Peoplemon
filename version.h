...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 3289;
	#define RC_FILEVERSION 9,6,238,1316
	#define RC_FILEVERSION_STRING "9, 6, 238, 1316\0"
	static const char FULLVERSION_STRING [] = "9.6.238.1316";
