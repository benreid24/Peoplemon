...
namespace AutoVersion{
	...
	static const long BUILDS_COUNT  = 5355;
	#define RC_FILEVERSION 14,2,41,225
	#define RC_FILEVERSION_STRING "14, 2, 41, 225\0"
	static const char FULLVERSION_STRING [] = "14.2.41.225";
